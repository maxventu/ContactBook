          ...
          <div class="form-group">
            <div class="row">
              <div class="col-lg-4">
                ...
                <input type="text"  class="form-control" id="attachmentAddModal_filename" placeholder="Filename">
              </div>
              <div class="col-lg-8">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-lg-12">
                ...
                <input type="text" class="form-control" id="attachmentAddModal_comment" placeholder="Add coments here">
              </div>
            </div>
          </div>
